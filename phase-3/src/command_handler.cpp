...
void CommandHandler::Run(std::string Line)
{
	try
	{
...
int CommandHandler::GetSessionID()
{
	return VirtualNetwork->GetLoggedInUser()->GetUserID();
}

Network* CommandHandler::GetNetwork()
{
