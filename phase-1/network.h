...
public:
	...
	void RecommendFilms(int FilmID);
	bool IsInBestRatedFilms(std::vector<Film*> FilmsSortByRates, Film* ChosenFilm);
	...
	void ShowFollowers();
	std::vector<Film*> SortFilms();
	std::vector<Film*> SortFilmsByRate(std::vector<Film*> Films);
	std::vector<Film*> SortFilmsByFilmID(std::vector<Film*> Films);
